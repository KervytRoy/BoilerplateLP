...
@Component({
  selector: 'app-main',
  standalone: true,
  imports: [FooterComponent,ContactFormComponent,OurValuesComponent,NavBarComponent,HeaderComponent,FlayersComponent,OurServicesComponent,CommentAndVideoComponent,WhoWeAreComponent ],
